...
const orderSchema = z.object({
  ...
  phone: z.string().refine((val) => phoneRegex.test(val), 'Telefone inválido'),
  document: z.string().refine((val) => documentRegex.test(val), 'Documento inválido'),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (paymentMethod === 'financiamento') {
      try {
        ...
        // Delegando a decisão para a função pura em src/lib/creditDecision.ts
        orderStatus = determineCreditStatus(score, totalPrice, entryValue);
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.name && <p className="text-sm text-destructive" data-testid="form-message">{errors.name}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.lastname && <p className="text-sm text-destructive" data-testid="form-message">{errors.lastname}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    />
                    {errors.email && <p className="text-sm text-destructive" data-testid="form-message">{errors.email}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.phone && <p className="text-sm text-destructive" data-testid="form-message">{errors.phone}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.document && <p className="text-sm text-destructive" data-testid="form-message">{errors.document}</p>}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.store && <p className="text-sm text-destructive" data-testid="form-message">{errors.store}</p>}
                  </div>
                </div>
              </section>
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {errors.terms && <p className="text-sm text-destructive mt-1" data-testid="form-message">{errors.terms}</p>}
                  </div>
                </div>
              </section>
