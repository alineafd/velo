...
```env
VITE_SUPABASE_PROJECT_ID="znwprdwniwtocmitjwjj"
VITE_SUPABASE_PUBLISHABLE_KEY="sb_publishable_-8tjIfgKS5v-gHau8QM-pw_NxZex6FY"
VITE_SUPABASE_URL="https://znwprdwniwtocmitjwjj.supabase.co"
```
...
yarn supabase login
yarn supabase link --project-ref znwprdwniwtocmitjwjj
